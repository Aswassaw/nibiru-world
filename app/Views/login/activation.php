...
<div class="card bg-light">
    <div class="card-body">
        <center>
            <h1 title="Tidak Ada Status" class="fas">Aktifkan Akun Anda!</h1>
            <hr>
            ...
            <?php if (session()->getFlashdata('danger')) : ?>
                ...
                <hr>
            <?php endif; ?>
            <h5>Kami Telah Mengirimkan Link Verifikasi Untuk <strong><?= session()->get('verify_email') ?></strong>, Tolong Aktifkan Akun Anda Sebelum 30 Menit Sejak Kami Mengirimkan Email Kepada Anda.</h5>
            ...
            <div class="collapse" id="collapseExample">
                <div class="card card-body">
                    <form class="mt-3" action="<?= base_url('activation') ?>" method="post">
                        <!-- Form Email -->
